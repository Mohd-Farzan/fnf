...
export const SignupUser = createAsyncThunk(
    ...
    async (FormData, { rejectWithValue }) => {
        try {
            const response = await axios.post('https://fnf-eun3.onrender.com/api/auth/signup', FormData, {
...
export const LoginUser = createAsyncThunk(
    ...
    async (FormData, { rejectWithValue }) => {
        try {
            const response = await axios.post('https://fnf-eun3.onrender.com/api/auth/login', FormData, {
                withCredentials: true
            });
...
export const LogoutUser = createAsyncThunk(
    ...
    async (_, { rejectWithValue }) => {
        try {
            const response = await axios.post('https://fnf-eun3.onrender.com/api/auth/logout', {}, {
                withCredentials: true
            });
...
export const checkAuth = createAsyncThunk(
    ...
    async (_, { rejectWithValue }) => {
        try {
            ...
            const response = await axios.get('https://fnf-eun3.onrender.com/api/auth/checkauth', {
                withCredentials: true,
                headers: {
